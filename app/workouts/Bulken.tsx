          ...
          <ScrollView style={styles.scrollView}>
            <View style={styles.textBox}>
              <Text style={styles.text}>
                ...
                <Text style={styles.header}>Jouw Workout Routine voor Bulken en Spiergroei</Text>
                {'\n\n'}
                Klaar om serieus spiermassa op te bouwen en sterker te worden? Deze workout routine is specifiek ontworpen voor spiergroei en bulken. Volg dit plan vier tot vijf dagen per week om maximale spierontwikkeling te bereiken. Vergeet niet om voldoende te eten en te rusten, want spiergroei gebeurt niet alleen in de sportschool, maar ook tijdens het herstel!
                {'\n\n'}
                
                <Text style={styles.subHeader}>Frequentie:</Text> 4-5 dagen per week
                {'\n'}
                <Text style={styles.subHeader}>Duur:</Text> 60-90 minuten per sessie
                {'\n\n\n\n'}
                
                <Text style={styles.subHeader}>Dag 1: Krachttraining (Borst & Triceps)</Text>
                {'\n\n'}
                <Text style={styles.subHeader}>Opwarming (5-10 minuten)</Text>
                {'\n'}
                Begin met een opwarming zoals licht cardio of dynamisch rekken om je spieren voor te bereiden.
                {'\n\n'}
                
                <Text style={styles.subHeader}>Krachttraining (4 sets per oefening)</Text>
                {'\n\n'}
                ...
                {'\n'}
                Sluit af met lichte stretching voor je borst en triceps om de flexibiliteit te verbeteren.
                {'\n\n\n\n'}
                ...
                <Text style={styles.subHeader}>Opwarming (5-10 minuten)</Text>
                {'\n'}
                Begin met een lichte opwarming, zoals een roeimachine om je rug en biceps op te warmen.
                {'\n\n'}
                
                <Text style={styles.subHeader}>Krachttraining (4 sets per oefening)</Text>
                {'\n'}
                {/* Tabel voor rug- en bicepsoefeningen */}
                <View style={styles.table}>
                  <Text style={styles.tableHeader}>Oefening</Text>
                  <Text style={styles.tableHeader}>Herhalingen</Text>
                ...
                {'\n'}
                Neem een rustdag of kies voor een actieve herstelactiviteit zoals lichte cardio, stretching of yoga. Dit helpt je lichaam te herstellen en sterker te worden voor de volgende sessies.
                {'\n\n\n\n'}
                ...
                <Text style={styles.subHeader}>Opwarming (5-10 minuten)</Text>
                {'\n'}
                Voer een korte warming-up uit, zoals fietsen of lunges, om je benen en schouders voor te bereiden.
                {'\n\n'}
                
                <Text style={styles.subHeader}>Krachttraining (4 sets per oefening)</Text>
                {'\n'}
                {/* Tabel voor been- en schouderoefeningen */}
                <View style={styles.table}>
                  <Text style={styles.tableHeader}>Oefening</Text>
                  <Text style={styles.tableHeader}>Herhalingen</Text>
                ...
                <Text style={styles.subHeader}>Afkoelen (5-10 minuten)</Text>
                {'\n\n'}
                Zorg voor voldoende cooling-down met stretching voor je benen en schouders.
                {'\n\n'}
              </Text>
            </View>
          </ScrollView>
