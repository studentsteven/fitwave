        ...
        <View style={[styles.container, {width: screenWidth}]}>
            <View style={styles.items}>
                ...
                <View style={styles.box}>
                    <Image style={styles.img} source={require("../../assets/calories.png")}/>
                    <Text style={styles.text}>{Math.floor(Math.random() * (5000 - 100 + 1)) + 100}</Text>
                    <Text style={styles.text}>Cal</Text>
                </View>

                <View style={styles.box}>
                    <Image style={styles.img} source={require("../../assets/location-mark.png")}/>
